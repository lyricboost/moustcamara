...
<section class="<?php echo esc_attr($block_classes); ?>">
    <div class="grid-items-inner">
        <h2 class="grid-items-heading"><?php echo esc_html($heading); ?></h2>
        ...
        <?php else : ?>
            <div class="grid-items-grid">
                ...
                <div class="grid-item">
                    ...
                    <p class="grid-item-description">Hosting an event or conference? I speak on a number of topics from leveraging multiple passions and skills in the AI era to building a powerful brand.</p>
                    <a href="#" class="grid-item-button">Enquire About Booking</a>
                </div>
                <div class="grid-item">
                    <h3 class="grid-item-title">Resources & Structure</h3>
                    <p class="grid-item-description">I help multi-passionate women create structure with their passions through a number of resources designed to create clarity and magnify opportunities.</p>
                    <a href="#" class="grid-item-button">Explore The Resources</a>
                </div>
                <div class="grid-item">
                    <h3 class="grid-item-title">YouTube & Content</h3>
                    <p class="grid-item-description">My YouTube channel of over 180,000 subs helps people with multiple passions develop through structure, inspiration and frameworks.</p>
